 ...
 * 得到的值），这里的的开始时间戳，一般是我们的id生成器开始使用的时间，由我们程序来指定的（如下面程序IdWorker类的startTime属性）。41位的时间戳，可以使用69年，年T = (1L << 41) / (1000L * 60 * 60 * 24 * 365) = 69
...
//            System.out.println(Long.toBinaryString(id));
        ...
        for (int i = 0; i < 50000; i++) {
            long id = idWorker.generateId().longValue();
            System.out.println(id);
//            System.out.println(Long.toBinaryString(id));
        }
    }
